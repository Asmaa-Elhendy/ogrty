...
//
//     final fetchReplyModel = fetchReplyModelFromJson(jsonString);

import 'dart:convert';

FetchReplyModel fetchReplyModelFromJson(String str) =>
    FetchReplyModel.fromJson(json.decode(str));

String fetchReplyModelToJson(FetchReplyModel data) =>
    json.encode(data.toJson());

class FetchReplyModel {
  FetchReplyModel({
    this.docs,
    this.totalDocs,
    this.limit,
  ...
  factory FetchReplyModel.fromJson(Map<String, dynamic> json) =>
      FetchReplyModel(
        docs: json["docs"] == null
            ? null
