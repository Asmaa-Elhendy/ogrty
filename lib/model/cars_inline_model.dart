...
//
//     final carsInLineModel = carsInLineModelFromJson(jsonString);

import 'dart:convert';

List<CarsInLineModel> carsInLineModelFromJson(String str) =>
    List<CarsInLineModel>.from(json.decode(str).map((x) => CarsInLineModel.fromJson(x)));

String carsInLineModelToJson(List<CarsInLineModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class CarsInLineModel {
  CarsInLineModel({
    this.id,
    this.type,
    this.owner,
  ...
  factory CarsInLineModel.fromJson(Map<String, dynamic> json) => CarsInLineModel(
