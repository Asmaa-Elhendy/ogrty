...
//
//     final carsInParkingModel = carsInParkingModelFromJson(jsonString);

import 'dart:convert';

List<CarsInParkingModel> carsInParkingModelFromJson(String str) =>
    List<CarsInParkingModel>.from(
        json.decode(str).map((x) => CarsInParkingModel.fromJson(x)));

String carsInParkingModelToJson(List<CarsInParkingModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class CarsInParkingModel {
  CarsInParkingModel({
    this.id,
    this.type,
    this.owner,
  ...
  factory CarsInParkingModel.fromJson(Map<String, dynamic> json) => CarsInParkingModel(
